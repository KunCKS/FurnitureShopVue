<template>
  <section>
    ...
    >
      ...
      <p
        class="introduce-company-section-content col-10 text-center text-white mt-3"
      >我們的品質不僅僅是對美學的追求。我們推崇精湛的工藝，一絲不苟地關注細節，堅持選擇最高品質的材料。我們的卓越聲譽和全球業務，使我們能夠從世界各地挑選出最為優秀的專家。而我們在做到這一點的同時，還牢記動物、工人以及整個地球的福祉。</p>
      <a href="#" class="introduce-company-section-btn btn btn-outline-light mt-4">ASIN 簡介</a>
    </div>
  </section>
</template>